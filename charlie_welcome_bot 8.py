...
CHARLIE_GIFS = [
    "https://media.tenor.com/JBx6lPZqXaQAAAAd/hazbin-hotel-charlie.gif",
    "https://media.tenor.com/5VYJ1bQr3CQAAAAd/hazbin-hotel-charlie-morningstar.gif",
]

VAGGIE_GIFS = [
    "https://media.tenor.com/7bK0jX5fYlEAAAAd/hazbin-hotel-vaggie.gif",
    "https://media.tenor.com/vaggie-hazbin-hotel-hello.gif",
]

ANGEL_GIFS = [
    "https://media.tenor.com/angel-dust-hazbin-hotel-hello.gif",
    "https://media.tenor.com/fat-nuggets-angel-dust.gif",
]

ALASTOR_GIFS = [
    "https://media.tenor.com/alastor-hazbin-hotel-smile.gif",
    "https://media.tenor.com/alastor-radio-demon.gif",
]

CHERRI_GIFS = [
    "https://media.tenor.com/cherri-bomb-hazbin.gif",
]

NIFFTY_GIFS = [
    "https://media.tenor.com/niffty-hazbin-hotel.gif",
]

HUSK_GIFS = [
    "https://media.tenor.com/husk-hazbin-hotel.gif",
]

LUCIFER_GIFS = [
    "https://media.tenor.com/lucifer-morningstar-hazbin.gif",
]

ROSIE_GIFS = [
    "https://media.tenor.com/rosie-hazbin-hotel.gif",
]
...
CHARACTERS = {
    "charlie": {
        ...
        "gifs": CHARLIE_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/sad-charlie-hazbin-hotel.gif",
            "https://media.tenor.com/charlie-crying-hazbin.gif",
        ],
    ...
    "vaggie": {
        ...
        "gifs": VAGGIE_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/vaggie-sad-hazbin.gif",
        ],
    ...
    "angel": {
        ...
        "gifs": ANGEL_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/angel-dust-sad-hazbin.gif",
        ],
        "tenor_query": "Angel Dust Hazbin Hotel happy",
    ...
    "alastor": {
        ...
        "gifs": ALASTOR_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/alastor-wave-hazbin.gif",
        ],
        "tenor_query": "Alastor Hazbin Hotel smile",
    ...
    "cherri": {
        ...
        "gifs": CHERRI_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/cherri-bomb-sad.gif",
        ],
        "tenor_query": "Cherri Bomb Hazbin Hotel party",
    ...
    "niffty": {
        ...
        "gifs": NIFFTY_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/niffty-cry-hazbin.gif",
        ],
        "tenor_query": "Niffty Hazbin Hotel hyper",
    ...
    "husk": {
        ...
        "gifs": HUSK_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/husk-sad-hazbin.gif",
        ],
        "tenor_query": "Husk Hazbin Hotel grumpy",
    ...
    "lucifer": {
        ...
        "gifs": LUCIFER_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/lucifer-sad-hazbin.gif",
        ],
    ...
    "rosie": {
        ...
        "gifs": ROSIE_GIFS,
        "goodbye_gifs": [
            "https://media.tenor.com/rosie-sad-hazbin.gif",
        ],
...
async def on_member_remove(member: discord.Member):
    ...
    if channel is not None:
        ...
        gif = random.choice(char.get("goodbye_gifs", char["gifs"]))
