...
# --- Direct GIF URLs (all end in .gif for proper Discord embedding) ----------

CHARLIE_GIFS = [
    "https://gifdb.com/images/high/charlie-morningstar-hazbin-hotel-yu4w9e9rqu2iiibi.gif",
    "https://gifdb.com/images/high/happy-charlie-morningstar-hazbin-hotel-icmiy7p1r3qijzli.gif",
    "https://gifdb.com/images/high/happy-and-excited-charlie-morningstar-hazbin-hotel-tmwtiu856tf73h69.gif",
    "https://gifdb.com/images/high/charlie-magne-hazbin-hotel-532wk9hpnj46ikcz.gif",
    "https://gifdb.com/images/high/charlie-morningstar-hazbin-hotel-gif-nuhd215rx4bfsc3h.gif",
    "https://gifdb.com/images/high/hazbin-hotel-charlie-morningstar-gif-c2famd1po7su6wc2.gif",
]

VAGGIE_GIFS = [
    "https://gifdb.com/images/high/charlie-and-vaggie-hazbin-hotel-ky2svzib9gzzc20m.gif",
    "https://gifdb.com/images/high/vaggie-s-spear-hazbin-hotel-7dpf2yknzkqwfb2x.gif",
    "https://gifdb.com/images/high/angel-dusk-and-vaggie-shut-up-hazbin-hotel-p1w8czv50vy75mo4.gif",
]

ANGEL_GIFS = [
    "https://gifdb.com/images/high/angel-dust-hazbin-hotel-xluwgc9tzhteqbku.gif",
    "https://gifdb.com/images/high/cute-angel-dust-hazbin-hotel-ddfwa83dqkvlnxjk.gif",
    "https://gifdb.com/images/high/angel-dust-shrug-hazbin-hotel-79bk40uu3odx90fu.gif",
    "https://gifdb.com/images/high/angel-dust-kinky-hazbin-hotel-hmfebloqd38vwpzp.gif",
    "https://gifdb.com/images/high/fat-nuggets-and-angel-dust-hazbin-hotel-pbzunp1diwba76jy.gif",
]

ALASTOR_GIFS = [
    "https://gifdb.com/images/high/alastor-smile-hazbin-hotel-q2m8bwf6u588a5ij.gif",
    "https://gifdb.com/images/high/alastor-glitch-hazbin-hotel-isihhq1uvemkx49z.gif",
    "https://gifdb.com/images/high/alastor-says-anyway-hazbin-hotel-i6z3er7bp2khuceq.gif",
    "https://gifdb.com/images/high/alastor-and-carlie-hazbin-hotel-5q9pr69asq8yays5.gif",
    "https://gifdb.com/images/high/vox-and-alastor-hazbin-hotel-nhsdy15scediiuhx.gif",
    "https://gifdb.com/images/high/human-alastor-hazbin-hotel-rqw040ajbzdlltpn.gif",
    "https://gifdb.com/images/high/hazbin-hotel-hazbin-hotel-alastor-gif-ck8cpxnzc7ycz4jd.gif",
]

CHERRI_GIFS = [
    "https://gifdb.com/images/high/cherry-bomb-hazbin-hotel-m8sq9xr69b0uswl5.gif",
]

NIFFTY_GIFS = [
    "https://gifdb.com/images/high/niffty-and-alastor-hazbin-hotel-ag30lm264p5ei0g6.gif",
    "https://gifdb.com/images/high/niffty-ht-by-a-door-hazbin-hotel-2cjw2iilak4ipyeo.gif",
]

HUSK_GIFS = [
    "https://gifdb.com/images/high/husk-hazbin-hotel-gkt743gjj6wzospj.gif",
    "https://gifdb.com/images/high/annoyed-husk-hazbin-hotel-z17qpa8wq4fke1rh.gif",
    "https://gifdb.com/images/high/can-i-have-a-word-husk-gif-yh48uyd9t70ymkbx.gif",
]

LUCIFER_GIFS = [
    "https://gifdb.com/images/high/lucifer-morningstar-hazbin-hotel-6wf19qos1xn2sbo7.gif",
    "https://gifdb.com/images/high/lucifer-morningstar-hazbin-hotel-p6t9o9pwe4zxr0fu.gif",
]

ROSIE_GIFS = [
    "https://gifdb.com/images/high/hazbin-hotel-charlie-morningstar-gif-c2famd1po7su6wc2.gif",
    "https://gifdb.com/images/high/three-cartoon-characters-celebrating-yay-5gmrkmlvfnu9p9r0.gif",
]
...
def _gif_image_url(gif: str) -> str | None:
    """Return the URL only if it's a direct image link (ends in .gif)."""
...
async def on_member_join(member: discord.Member):
    ...
    try:
        ...
        dm_gif_url = _gif_image_url(dm_gif)
        if dm_gif_url:
