...
CHARACTERS = {
    ...
    "Vox": {"color": 0x00BFFF, "gifs": ["https://static.klipy.com/ii/4e7bea9f7a3371424e6c16ebc93252fe/62/5a/ZxZVHTFDqQoF8b4bfZxx.gif", "https://static.klipy.com/ii/4e7bea9f7a3371424e6c16ebc93252fe/7d/82/iIOPz6KR9Qe3nhO.gif"], "quotes": ["I OWN the airwaves in Hell. Everyone else is just background noise.", "Alastor thinks he's relevant. How ADORABLY outdated.", "Television is the future. Radio is a museum piece. Like Alastor.", "I didn't become an overlord by being NICE.", "You want power? Get with the times. Or get out of my way.", "My network reaches every corner of Hell. You're always watching me.", "Valentino and Velvette? They work for ME. Never forget it.", "The V's run Hell now. The rest of you are just living in it."]},
    "Valentino": {"color": 0x8B008B, "gifs": ["https://static.klipy.com/ii/4493325008d34b7bf8cd6813cd5c1619/9a/9e/EpOg1wTCTv2dR0W.gif", "https://static.klipy.com/ii/4493325008d34b7bf8cd6813cd5c1619/20/a8/Q0Jr0rNol1pwIZ.gif"], "quotes": ["You're ALL my talent. Whether you like it or not.", "Contracts are binding, darling. You signed in blood.", "I made Angel Dust a STAR. He should be THANKING me.", "In my studio, everyone performs. One way or another.", "The V's don't lose. We don't know how.", "Power is about control. And I control everything you see.", "You think you can break a contract with ME? Cute.", "Fashion, fame, fortune -- I own it all. You just rent."]},
    "Velvette": {"color": 0xFF00FF, "gifs": ["https://static.klipy.com/ii/4e7bea9f7a3371424e6c16ebc93252fe/16/d6/B2dNiQT1VMu8FMl1T.gif", "https://static.klipy.com/ii/4493325008d34b7bf8cd6813cd5c1619/c8/60/DBrXLy02CqgR.gif"], "quotes": ["Social media runs Hell now, sweetie. Keep up.", "I'm not just the face of the V's -- I'm the BRAINS.", "One post from me and your reputation is DONE.", "Trends don't happen. I MAKE them happen.", "You're not famous until Velvette says you're famous.", "Outdated? Moi? I'm the only one in Hell with a smartphone.", "I manage the image. Vox handles the tech. Val handles... talent.", "Don't make me cancel you. I mean that literally."]},
    "Carmilla Carmine": {"color": 0xC0C0C0, "gifs": ["https://static.klipy.com/ii/4e7bea9f7a3371424e6c16ebc93252fe/c4/ff/T0lDjwWfhiAA.gif", "https://static.klipy.com/ii/da290b156d64898341638f3c299e7478/fe/36/Sb3Ypd60.gif"], "quotes": ["I built my empire from nothing. What have YOU done?", "The angelic weapons trade keeps Hell running. And I run the trade.", "I have daughters. I know when someone's full of excuses.", "Power isn't given. It's taken. And I took mine.", "He doesn't make deals with just anyone. You have to prove yourself.", "Angels fall. Weapons don't. Smart investment.", "Zestial is an old friend. We understand each other.", "I've survived every purge. Not by hiding. By fighting."]},
    "Zestial": {"color": 0x2F4F2F, "gifs": ["https://static.klipy.com/ii/4e7bea9f7a3371424e6c16ebc93252fe/d9/63/ZbPRogiqojxYY4.gif", "https://static.klipy.com/ii/4e7bea9f7a3371424e6c16ebc93252fe/18/90/HtPyDv8KsZyC4bUe.gif"], "quotes": ["I have walked these halls since before many souls were born.", "Patience, young one. Power comes to those who wait.", "I have seen empires rise and fall. The key is to outlast them.", "Carmilla is a dear ally. Her ambition reminds me of myself.", "The old ways are the best ways. Modernity is fleeting.", "He speaks in riddles because the truth is too sharp for most.", "An overlord's true strength is not in their power, but in their wisdom.", "Hell changes, but I remain. There is a lesson in that."]},
    "Zeezi": {"color": 0x9370DB, "gifs": ["https://static.klipy.com/ii/4493325008d34b7bf8cd6813cd5c1619/9b/9c/oEqW5mPlFdUfTK3.gif", "https://static.klipy.com/ii/4493325008d34b7bf8cd6813cd5c1619/45/d8/wbPuWxO1Z3CNh8gFo.gif"], "quotes": ["Being an overlord isn't about power. It's about presence.", "I've been watching Hell's politics for centuries. It's always the same show.", "Rosie and I go way back. Don't believe everything you hear.", "You think you understand Hell? You've barely scratched the surface.", "The balance of power shifts constantly. I simply shift with it.", "I don't need to shout to be heard. That's for amateurs.", "Every overlord has secrets. Mine are just better hidden.", "The game of Hell never ends. You either play or get played."]}
}
...
async def daily_quote():
    ...
    if not channel:
        print(f"Error: Channel ID {QUOTES_CHANNEL_ID} not found")
        return
    while True:
        ...
        next = now.replace(hour=target_hr, minute=target_min, second=0, microsecond=0)
        if next <= now:
            next = next.replace(day=next.day + 1)
        sleep = (next - now).total_seconds()
        print(f"Next quote at {next} ({sleep} seconds)")
