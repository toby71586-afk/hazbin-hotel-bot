...
Every new member gets welcomed by a RANDOM character —
 ...
 Also says goodbye when someone leaves — only in the goodbye channel.
"""
...
async def on_member_join(member: discord.Member):
    ...
    # Only send welcome if WELCOME_CHANNEL_ID is set and valid
    channel = None
    ...
    # DM always still works (no channel needed)
    try:
...
async def on_member_remove(member: discord.Member):
    ...
    # Only send goodbye if GOODBYE_CHANNEL_ID is set and valid
    channel = None
